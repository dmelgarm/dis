...
\centering
  \includegraphics[width=0.99\linewidth]{./figures/ch2/abc_map_offsets.pdf}
    \caption[Coseismic offset comparison]{Comparison between static offsets determined from the automated baseline corrected procedure and the real-time GPS. (a) Are horizontal and (b) are vertical offsets}
